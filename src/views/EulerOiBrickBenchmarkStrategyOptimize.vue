  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="p-4 sm:p-6 mx-auto max-w-5xl">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">
        （策略优化）单边欧拉 · OI 加权（1m 点砖 + 5m metrics）
      </h1>
      <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 space-y-1">
        <span class="block">
          砖石线由本地 <code class="px-1 rounded bg-gray-200 dark:bg-gray-800">*_1m.jbar</code> 按所选基准时钟聚合；<strong>Q</strong>=主腿砖收益 Z，
        ...
        <span class="block mt-2 text-indigo-900 dark:text-indigo-200">
          <strong>本页策略优化</strong>：默认仅对 <strong>I</strong> 作短 EMA；<strong>Q</strong> 不跨砖平滑以保持价方向与象限一致。可选<strong>施密特 + 价格熔断</strong>（进入/维持门槛与 Q 符号强拆错色锁存）。参数见「量化抖动抑制」。简易回测区块下方另有<strong>共振动力学矩阵回测</strong>（与成交额砖策略页同源：`simulateEulerResonanceMatrixSpotBacktest`）。
          <span class="block mt-1 text-sm">
            <strong>下一砖变色龙（惯性 θ+Δθ）</strong>：加载砖后出现在「欧拉 / 静风阈 / Z 窗」区块内——<strong>四维大盘正上方</strong>紫条（摘要）与<strong>大盘正下方</strong>说明卡（详情）。仅本页；普通「单边欧拉」页无此条。
          </span>
        </span>
      </p>
